	...
	void performAction(int action) {
		...
		switch(action){
			...
			case 3: // Middle
				...
				break;
			case 4: // Left and middle
				leftEngine.setBursting(true);
				middleEngine.setBursting(true);
				break;
			case 5: // Middle and right
				rightEngine.setBursting(true);
				middleEngine.setBursting(true);
				break;
			case 6: // Middle and right
				rightEngine.setBursting(true);
				middleEngine.setBursting(true);
				leftEngine.setBursting(true);
				break;
	...
	public void tick(int currentTime) {
		...
		if (!paused) {
			...
			if (previous_state != null) {
				...
				/* TODO: IMPLEMENT Q-UPDAT(E HERE! */
				double qt = Qtable.get(prev_stateaction) + alpha(Ntable.get(prev_stateaction))*(previous_reward + GAMMA_DISCOUNT_FACTOR * getMaxActionQValue(new_state) - Qtable.get(prev_stateaction));
				Qtable.put(prev_stateaction, qt);
